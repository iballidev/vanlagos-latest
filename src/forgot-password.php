...
<div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-4">
        <div class="col-span-4 sm:col-start-2 sm:col-end-3 lg:col-span-6">
                ...
                <div class="p-6">
                    ...
                    <form action="">
                        <ul class="grid grid-cols-1 gap-y-4">
                            <li class="col-span-1">
                                <label for="username" class="block font-semibold mb-2 cursor-pointer">Email Addres</label>
                            ...
                            <li class="col-span-1">
                                ...
                                <div class="max-w-60 mx-auto">
                                    <button class="mdc-button w-full bg-primary py-6 mdc-card">
                                        ...
                                        <span class="mdc-button__label text-white capitalize">Send link</span>
                                    </button>
                                </div>
                            </li>
                        </ul>
