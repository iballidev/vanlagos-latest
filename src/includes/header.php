    ...
    <!-- <nav class="bg-gray-800 sm:bg-light"> -->
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
          ...
          -->
                ...
                <div class="flex flex-1 items-center justify-between sm:items-stretch">
                    <div class="flex flex-shrink-0 items-center">
                        <img class="h-8 w-auto ml-10 sm:ml-0" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=500" alt="Your Company">
                    </div>
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <div class="relative">
                        <div>
                            <button type="button" class="pill after-pseudo-icon caret-down bg-primary hover:bg-blue-400 relative flex px-4 py-2 text-sm font-medium text-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
          ...
          -->
                    ...
                    <a href="#" class="hidden ml-2 pill bg-primary hover:bg-blue-400 text-white rounded-md px-3 py-2 text-sm font-medium">Sign
                        In / Sign Up</a>
                </div>
            </div>
        </div>
        ...
        <div class="sm:hidden" id="mobile-menu">
            <div class="space-y-1 px-2 pb-3 pt-2">
                ...
                <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Sign
                    In / Sign Up</a>
            </div>
        </div>
    </nav>
