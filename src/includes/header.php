          ...
          -->
                ...
                <div class="flex flex-1 items-center justify-between sm:items-stretch">
                    ...
                    <div class="hidden sm:ml-6 sm:block">
                        <div class="flex space-x-4">
                            ...
                            <a href="#"
                                class="pill bg-primary hover:bg-blue-400 text-white rounded-md px-3 py-2 text-sm font-medium">Sign
                                In / Sign Up</a>
                        </div>
                    </div>
                </div>
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <div class="relative ml-3">
                        <div>
                            <button type="button"
                                class="pill after-pseudo-icon caret-down bg-primary hover:bg-blue-400 relative flex px-4 py-2 text-sm font-medium text-white"
