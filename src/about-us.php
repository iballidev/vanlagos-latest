...
<div class="bg-banner-1">
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        ...
        <div class="py-16">
            <h1 class="font-bold text-center text-4xl sm:text-5xl text-dark-200">About Us</h1>
        </div>
    </div>
</div>
...
<section class="bg-accent">
    <div class="mx-auto max-w-7xl px-2 py-8 sm:pt-16 sm:px-6 lg:px-8">
            ...
            <li class="col-span-12">
                <div class="grid grid-cols-12 items-center gap-4 sm:gap-8">
                    <div class="col-span-12 sm:col-span-6 fade-in" data-delay="200">
                        <img src="./images/about-us-main-featured-image.png" alt="About-us featured image">
                    </div>
                    <div class="col-span-12 sm:col-span-6 fade-in" data-delay="400">
                        <p class="text-white sm:text-lg mb-2">Vanlagos.com is a reliable vehicle hiring company that provides premium services to our customers at an affordable and competitive market price. In the areas of safety, timeliness, efficiency and excellent customer service, Vanlagos provides outstanding offers for you. We also have tools in place to provide support and assist you in a situation which is why you should choose us.</p>

                        <p class="text-white sm:text-lg">Our rigorous vetting process has ensured that all our drivers are qualified and in compliance with all the regulations of applicable bodies.
                            When you book a bus/van with us, your safety is assured as a result of the trust you have established with us to get you to your location.</p>
                    </div>
                </div>
            </li>
        </ul>
...
<section>
    ...
    <div class="mx-auto max-w-7xl px-2 py-8 mb-16 sm:pt-16 sm:px-6 lg:px-8">
        <ul class="grid grid-cols-12 items-center gap-y-10 sm:gap-y-8">

            <li class="col-span-12">
                <div class="grid grid-cols-12 items-center gap-4 sm:gap-8">
                    <div class="col-span-12 sm:col-span-6 fade-in" data-delay="200">
                        <img src="./images/punctuality-featured-image-alt.png" alt="Punctuality featured image">
                    </div>
                    <div class="col-span-12 sm:col-span-6 fade-in" data-delay="400">
            ...
            <li class="col-span-12">
                <div class="grid grid-cols-12 items-center gap-4 sm:gap-8">
                    ...
                    <div class="col-span-12 sm:col-span-6 order-1 sm:order-2 fade-in" data-delay="400">
                        <img src="./images/air-conditioned-buses-featured-image-alt.png" alt="Air Conditioned Buses featured image">
                    </div>
                </div>
            </li>
            ...
            <li class="col-span-12">
                <div class="grid grid-cols-12 items-center gap-4 sm:gap-8">
                    <div class="col-span-12 sm:col-span-6 fade-in" data-delay="450">
                        <img src="./images/comfortable-seats-and-leg-space-featured-image-alt.png" alt="Comfortable seats & leg space featured image">
                    </div>
