                            ...
                            <div class="p-2 sm:p-6">
                                ...
                                <div class="">
                                    ...
                                    <div class="">
                                        ...
                                        <button type="button" class="mdc-button payment-tab-btn"
                                            data-tab="payment-tab2">USE BANK TRANSFER</button>
                                    </div>
                                                ...
                                                <div class="grid grid-cols-12 gap-4 p-4">
                                                    <div class="col-span-12 sm:col-span-8">
                                                        <label for="card_number"
                                                            class="block text-gray-600 text-sm font-medium mb-1">Card
                                                            Number</label>
                                                        <div
                                                    ...
                                                    <div class="col-span-12 sm:col-span-4">
                                                        <div>
                                                            <label for="expiration_date"
                                                                class="block text-gray-600 text-sm font-medium mb-1">Expiration
                                                                Date</label>
                                                            <div
                                                                class="mdc-text-field mdc-text-field--outlined mdc-text-field--no-label block">
                                                                <input type="tel" id="expiration_date"
                                                                    name="expiration_date"
                                                                    class="mdc-text-field__input error"
                                                                    aria-label="Label" placeholder="MM/YY" required
                                                    ...
                                                    <div class="col-span-6 sm:col-span-4">
                                                        <label for="cvc"
                                                            class="block text-gray-600 text-sm font-medium mb-1">CVC</label>
                                                        <div
                                                            class="mdc-text-field mdc-text-field--outlined mdc-text-field--no-label block">
                                                            <input type="tel" id="cvc" name="cvc"
                                                                class="mdc-text-field__input error" aria-label="Label"
                                                                placeholder="123" required maxlength="3" required>
                                                            <span class="mdc-notched-outline">
                                                                <span class="mdc-notched-outline__leading"></span>
                                                                <span class="mdc-notched-outline__trailing"></span>
                                                            </span>
                                        ...
                                        <div id="payment-tab2" class="hidden payment-tab-content">
                                            ...
                                            <div class="mdc-card overflow-hidden">
                                                ...
                                                <div class="grid grid-cols-12 gap-4 p-4">
                                                    <div class="col-span-12 sm:col-span-6">
                                                        <label for="first_name"
                                                            class="block text-gray-600 text-sm font-medium mb-1">First
                                                            Name</label>
                                                        <input type="text" id="first_name" name="first_name"
                                                            class="form-input w-full p-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
                                                    </div>
                                                    <div class="col-span-12 sm:col-span-6">
                                                        <div>
                                                            <label for="last_name"
                                                                class="block text-gray-600 text-sm font-medium mb-1">Last
                                                                Name</label>
