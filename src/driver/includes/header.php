...
<body>
    ...
    <nav class="bg-[var(--bg-white)] mdc-card rounded-none">
        ...
        <div x-data="{ isOpen: false }">
                        ...
                        <div x-data="{ isOpen: false }">
                            ...
                            <div class="relative">
                                <div class="relative z-40 sm:z-40">
                                    <button @click="isOpen = !isOpen" type="button"
                                        class="mdc-button overflow-hidden primary-btn pill after-pseudo-icon caret-down hover:bg-blue-400 relative flex px-4 py-2 text-sm font-medium text-light"
          ...
          -->
                                ...
                                <div x-show="isOpen" x-transition:enter="transition ease-out duration-3000"
                                    ...
                                    <a href="./driver-profile.php" class="block px-4 py-2 text-sm text-gray-700"
                                        role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</a>
                                    <a href="./driver-settings.php" class="block px-4 py-2 text-sm text-gray-700"
                        ...
                        <a href="./login.php"
                            class="overflow-hidden ml-2 pill mdc-button primary-btn hover:bg-blue-400 text-white rounded-md px-3 py-1 text-sm text-sm font-medium capitalize">
                            Sign In / Sign Up
