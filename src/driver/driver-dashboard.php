            ...
            <div class="grid grid-cols-12 gap-4">
                <div class="col-span-12 sm:col-span-4">
                    <div class="mdc-card flex-row gap-4 h-full p-4">
                        <span class="bg-blue-100 h-20 w-20 flex items-center justify-center | rounded-full text-blue-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-blue-400 border border-blue-400">
                ...
                <div class="col-span-12 sm:col-span-4">
                    <div class="mdc-card flex-row gap-4 h-full p-4">
                        <span class="bg-blue-100 h-20 w-20 flex items-center justify-center | rounded-full text-green-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-green-400 border border-green-400">
                ...
                <div class="col-span-12 sm:col-span-4">
                    <div class="mdc-card flex-row gap-4 h-full p-4">
                        <span class="bg-red-100 h-20 w-20 flex items-center justify-center | rounded-full text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-red-400 border border-red-400">
