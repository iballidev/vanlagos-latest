                                ...
                                <ul>
                                    <li class="mb-4">
                                        <div class="grid grid-cols-12 gap-4">
                                            <div class="col-span-12 sm:col-span-6">
                                                <label for="first_name" class="block font-semibold cursor-pointer mb-2 required">First Name</label>
                                                <div class="mdc-text-field mdc-text-field--outlined w-full">
                                                    <input type="text" name="first_name" id="first_name" class="mdc-text-field__input error" aria-label="Label" required>
                                            ...
                                            <div class="col-span-12 sm:col-span-6">
                                                <label for="last_name" class="block font-semibold cursor-pointer mb-2 required">Last Name</label>
                                                <div class="mdc-text-field mdc-text-field--outlined w-full">
                                                    <input type="text" name="last_name" id="last_name" class="mdc-text-field__input error" aria-label="Label" required>
                                                    <span class="mdc-notched-outline">
                                                        <span class="mdc-notched-outline__leading"></span>
                                                        <span class="mdc-notched-outline__trailing"></span>
                                                    </span>
                                            ...
                                            <div class="col-span-12 sm:col-span-6">
                                                <label for="phone_number" class="block font-semibold cursor-pointer mb-2 required">Phone</label>
                                                <div class="mdc-text-field mdc-text-field--outlined w-full">
                                            ...
                                            <div class="col-span-12 sm:col-span-6">
                                                <label for="email_address" class="block font-semibold cursor-pointer mb-2 required">Email Address</label>
                                                <div class="mdc-text-field mdc-text-field--outlined w-full">
                                            ...
                                            <div class="col-span-12">
                                                <label for="company_name" class="block font-semibold cursor-pointer mb-2">Company Name (Optional)</label>
                                                <div class="mdc-text-field mdc-text-field--outlined w-full">
                                                    <input type="text" name="company_name" id="company_name" class="mdc-text-field__input" aria-label="Label" required>
                                                    <span class="mdc-notched-outline">
                                                        <span class="mdc-notched-outline__leading"></span>
                                                        <span class="mdc-notched-outline__trailing"></span>
                                                    </span>
                                            ...
                                            <div class="col-span-12">
                                                <label for="country" class="block font-semibold cursor-pointer mb-2 required">Country</label>
                                                <div class="mdc-text-field mdc-text-field--outlined w-full select">
                                                    <select id="country" name="country" class=" mdc-text-field__input error" aria-label="Label" required>
                                            ...
                                            <div class="col-span-12">
                                                <label for="state" class="block font-semibold cursor-pointer mb-2 required">State</label>
                                                <div class="mdc-text-field mdc-text-field--outlined w-full select">
                                                    <select id="state" name="state" class=" mdc-text-field__input error" aria-label="Label" required>
                                            ...
                                            <div class="col-span-12">
                                                <label for="address" class="block font-semibold cursor-pointer mb-2 required">Address</label>
                                                <div class="mdc-text-field mdc-text-field--outlined w-full">
                                                    <input type="text" name="address" id="address" class="mdc-text-field__input error" aria-label="Label" required>
                                                    <span class="mdc-notched-outline">
                                                        <span class="mdc-notched-outline__leading"></span>
                                                        <span class="mdc-notched-outline__trailing"></span>
                                                    </span>
                                            ...
                                            <div class="col-span-12">
                                                <label for="town_or_city" class="block font-semibold cursor-pointer mb-2 required">Town/City</label>
                                                <div class="mdc-text-field mdc-text-field--outlined w-full">
                                                    <input type="text" name="town_or_city" id="town_or_city" class="mdc-text-field__input error" aria-label="Label" required>
                                                    <span class="mdc-notched-outline">
                                                        <span class="mdc-notched-outline__leading"></span>
                                                        <span class="mdc-notched-outline__trailing"></span>
                                                    </span>
                                            ...
                                            <div class="col-span-12">
                                                ...
                                                <div class="mdc-text-field mdc-text-field--textarea mdc-text-field--no-label w-full">
                                                    ...
                                                    <span class="mdc-text-field__resizer">
                                                        <textarea class="mdc-text-field__input" id="other_notes" name="other_notes" rows="5" cols="40" aria-label="Label"></textarea>
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <li class="mb-4">
                                        <div class="col-span-12">
                                            <label for="package_description" class="block font-semibold mb-2 cursor-pointer">
                                                Description <span class="italic font-medium text-sm">(kindly let us know the
                                            ...
                                            <div class="mdc-text-field mdc-text-field--textarea mdc-text-field--no-label w-full">
                                                ...
                                                <span class="mdc-text-field__resizer">
                                                    <textarea class="mdc-text-field__input" id="package_description" name="package_description" rows="5" cols="40" aria-label="Label"></textarea>
                                                </span>
                                            </div>
                                        </div>
                                    </li>
                        ...
                        <div class="mdc-card fade-in" data-delay="300">
                            ...
                            <div class="p-2 sm:p-6">
                                ...
                                <div class="">
                                    <!-- Payment Method Tabs -->
                                    <div class="">
                                        <button type="button" class="mdc-button payment-tab-btn active" data-tab="payment-tab1">USE CARD</button>
                                        <button type="button" class="mdc-button payment-tab-btn" data-tab="payment-tab2">USE BANK TRANSFER</button>
                                    </div>
                                    ...
                                    <div class="py-4">
                                        ...
                                        <div id="payment-tab1" class="payment-tab-content">
                                            ...
                                            <div class="mdc-card overflow-hidden">
                                                <h6 class="bg-light-300 text-white py-2 px-4 font-semibold">Enter card
                                                    details</h6>
                                                <div class="grid grid-cols-12 gap-4 p-4">
                                                    <div class="col-span-12 sm:col-span-8">
                                                        <label for="card_number" class="block text-gray-600 text-sm font-medium mb-1">Card
                                                            Number</label>
                                                        <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--no-label block">
                                                            <input type="tel" id="card_number" name="card_number" class="mdc-text-field__input error" aria-label="Label" placeholder="0000 0000 0000 0000" required maxlength="19" required>
                                                            <span class="mdc-notched-outline">
                                                                <span class="mdc-notched-outline__leading"></span>
                                                                <span class="mdc-notched-outline__trailing"></span>
                                                            </span>
                                                    ...
                                                    <div class="col-span-12 sm:col-span-4">
                                                        <div>
                                                            <label for="expiration_date" class="block text-gray-600 text-sm font-medium mb-1">Expiration
                                                                Date</label>
                                                            <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--no-label block">
                                                                <input type="tel" id="expiration_date" name="expiration_date" class="mdc-text-field__input error" aria-label="Label" placeholder="MM/YY" required maxlength="5" required>
                                                                <span class="mdc-notched-outline">
                                                                    <span class="mdc-notched-outline__leading"></span>
                                                                    <span class="mdc-notched-outline__trailing"></span>
                                                                </span>
                                                    ...
                                                    <div class="col-span-6 sm:col-span-4">
                                                        ...
                                                        <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--no-label block">
                                                            <input type="tel" id="cvc" name="cvc" class="mdc-text-field__input error" aria-label="Label" placeholder="123" required maxlength="3" required>
                                                            <span class="mdc-notched-outline">
                                                                <span class="mdc-notched-outline__leading"></span>
                                                                <span class="mdc-notched-outline__trailing"></span>
                                                            </span>
                                        ...
                                        <div id="payment-tab2" class="hidden payment-tab-content">
                                            ...
                                            <div class="mdc-card overflow-hidden">
                                                ...
                                                <div class="grid grid-cols-12 gap-4 p-4">
                                                    <div class="col-span-12 sm:col-span-6">
                                                        <label for="first_name" class="block text-gray-600 text-sm font-medium mb-1">First
                                                            Name</label>
                                                    ...
                                                    <div class="col-span-12 sm:col-span-6">
                                                        <div>
                                                            <label for="last_name" class="block text-gray-600 text-sm font-medium mb-1">Last
                                                                Name</label>
